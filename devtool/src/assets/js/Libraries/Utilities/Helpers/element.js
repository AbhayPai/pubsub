...
export default (function () {
     ...
     * @param boolean bubble Flag to check if the has class should propagate
     * the checking
     * @param integer ceil The max times to bubble up a node
     *
     * @return boolean
    ...
    Element.getAttributes = function (el) {
        ...
        for (var att, i = 0, atts = el.attributes, n = atts.length;
            i < n; i++) {
            att = atts[i];
     ...
     * @param String className
     * @param Node parent insert automatically created tag inside this element
     * if provided
     *
     */
